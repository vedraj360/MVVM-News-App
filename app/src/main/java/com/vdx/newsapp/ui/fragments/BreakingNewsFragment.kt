...
import com.vdx.newsapp.util.Constants.Companion.QUERY_PAGE_SIZE
import com.vdx.newsapp.util.Resource
...
class BreakingNewsFragment : Fragment(R.layout.fragment_breaking_news) {
    ...
    private val TAG = "BreakNews Fragment"
            ...
            when (response) {
                ...
                is Resource.Error -> {
                    ...
                    response.message?.let { message ->
                        ...
                        if (message.contains("No internet") or message.contentEquals("Network Error")) {
                            Toast.makeText(activity, "No internet connection found", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
                is Resource.Loading -> {
